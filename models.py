...
class Intervention(BaseModel):
    ...
    id: str = Field(
        ..., 
        description="The Unique ID of the pipe or link you want to modify."
    )
    
    value: Optional[str] = Field(
        None, 
        description="For 'status' action: Use 'open' or 'close'."
    )
    
    diameter: Optional[float] = Field(
        None, 
        description="For 'set_diameter' or 'add_pipe': The pipe diameter in inches."
    )
    
    from_node: Optional[str] = Field(
        None, 
        description="For 'add_pipe': The ID of the node where the pipe starts."
    )
    
    to_node: Optional[str] = Field(
        None, 
        description="For 'add_pipe': The ID of the node where the pipe ends."
    )
